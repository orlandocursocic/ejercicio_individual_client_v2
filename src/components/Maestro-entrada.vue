<template>
  <div style="min-width:300px; max-width:300px; display:inline-block; vertical-align:top">
    <ul class="w3-ul w3-card-4">
      ...
      <li style="overflow: hidden; text-overflow: ellipsis" class="w3-hover-blue" v-for="Entrada in Entradas" @click="entradaSelected(Entrada.Id)"> Precio: {{Entrada.Precio }}, Sala: {{ Entrada.Sala }} </li>
    </ul>
  </div>
</template>
